...
describe('index/processImportArgsIntoListOfNames', function () {
    it('should a cleaned up list of place names and postal codes', function () {
        const inputArgsList = ['weather/', 'path/to/weather', 'New', 'York,', 'North', 'Vancouver,', 'London,', 'Pluto,', '10005']
        const expectedResultList = ['New York', 'North Vancouver', 'London', 'Pluto', '10005']
